...
const statusColorMap = {
  upcoming:
    "bg-yellow-500/20 text-yellow-800 border-yeloow-800/5",
  active: "bg-blue-500/20 text-blue-800 border-blue-800/5",
  completed:
    "bg-emerald-500/20 text-emerald-800 border-emerald-800/5",
  processing:
    "bg-rose-500/20 text-rose-800 border-rose-800/5",
  cancelled:
    "bg-gray-300/20 text-gray-800 border-gray-800/5",
};
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const Icon =
          statusIconMap[
            row.original
              .status as keyof typeof statusIconMap
          ];
        ...
        return (
          <Badge
            variant="outline"
            className={cn(
              "[]:size-4 text-muted-foreground capitalize",
              statusColorMap[
                row.original
